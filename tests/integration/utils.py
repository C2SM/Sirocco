...
This module provides helper functions for analyzing and validating workflow
execution timing and behavior in integration tests. These utilities are
specifically designed for tests that execute real workflows via AiiDA WorkGraph.
"""
