...
# TODO make them in aiida-icon part of the package so we can import them here and do not need to copy paste
#      Need to discuss with @ricoh how, do we create separate test package or just include pytest_fixtures in src?
...
# TODO make them in aiida-icon part of the package so we can import them here
#      Need to discuss with @ricoh how, do we create separate test package or just include pytest_fixtures in src?
@pytest.fixture
